...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `imageInsert` (IN `getName` VARCHAR(255), IN `getPath` VARCHAR(255), IN `getType` VARCHAR(255))  BEGIN
INSERT INTO book (coverName, coverPath, coverType) VALUES (getName, getPAth, getType);
END$$
...
(1, 'Don Quixote', 'El Ingenioso Hidalgo Don Quixote de la Mancha', 1605, 'Novel', 500, 'Spanish', 1, '20180430142543DonQuixote.jpg', '../View/pics/', 'image/jpeg'),
(2, 'A Tale of Two Cities', 'A Tale of Two Cities', 1859, 'Historical Fiction', 200, 'English', 2, '20180430142439aTaleofTwoCities.jpg', '../View/pics/', 'image/jpeg'),
(3, 'The Lord of the Rings', 'The Lord of the Rings', 1954, 'Fantasy/Adventure', 150, 'English', 3, '2018061607535920180430142623redChamber.jpg', '../View/pics/', 'image/jpeg'),
(4, 'The Litle Prince', 'Le Petit Prince', 1943, 'Fable', 142, 'French', 4, '20180430142559theLittlePrince.jpg', '../View/pics/', 'image/jpeg'),
(6, 'And Then There Were None', 'Ten Little Niggers', 1939, 'Mystery', 100, 'English', 6, '20180430142852default.png', '../View/pics/', 'image/png'),
(7, 'The Dream of the Red Chamber', 'The Story of the Stone', 1792, 'Novel', 100, 'Chinese', 7, '20180430142623redChamber.jpg', '../View/pics/', 'image/jpeg'),
(8, 'The Hobbit', 'There and Back Again', 1937, 'High Fantasy', 100, 'English', 3, '20180430142702theHobbit.jpg', '../View/pics/', 'image/jpeg'),
(9, 'She: A History of Adventure', 'She', 1886, 'FIction', 100, 'English', 8, '20180430142713She.jpg', '../View/pics/', 'image/jpeg');
...
INSERT INTO `users` (`usersID`, `username`, `password`, `role`) VALUES
...
--
ALTER TABLE `author`
  MODIFY `AuthorID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `book`
--
ALTER TABLE `book`
  MODIFY `BookID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
ALTER TABLE `booklink`
  ...
  ADD CONSTRAINT `booklink_ibfk_2` FOREIGN KEY (`usersID`) REFERENCES `users` (`usersID`) ON DELETE CASCADE ON UPDATE CASCADE;
